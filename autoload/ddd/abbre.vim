function ddd#abbre#apply(...) abort
  for name in a:000
    call call('ddd#abbre#' . name, [])
  endfor
endfunction

function ddd#abbre#glsl()
endfunction

function ddd#abbre#cpp()
...
function ddd#abbre#osg()
  ...
  :iab <buffer> ogagea osgGA::GUIEventAdapter
  :iab <buffer> ogagaa osgGA::GUIActionAdapter
  :iab <buffer> oxa osg::X_AXIS
  :iab <buffer> oya osg::Y_AXIS
  :iab <buffer> oza osg::Z_AXIS
  :iab <buffer> obe osg::BlendEquation
  :iab <buffer> ols osg::LightSource
  :iab <buffer> osss osgShadow::ShadowedScene
  :iab <buffer> ouiv osgUtil::IntersectionVisitor
...
function ddd#abbre#qt()
endfunction

" a little helper to comment duplicated abbrevation
function ddd#abbre#clearDuplicatedAbbrevation() abort
  while 1
    normal! j
    if line('.') == line('$')
      break
...
function ddd#abbre#bullet() abort
  iab <buffer> bb3 int3
  iab <buffer> bb32bas3 bt32BitAxisSweep3
  iab <buffer> bb4 int4
  iab <buffer> bbBBBTC BT_BOX_BOX_TRANSFORM_CACHE
  iab <buffer> bbBQBN BT_QUANTIZED_BVH_NODE
  iab <buffer> bbCKT CONTACT_KEY_TOKEN
  iab <buffer> bbCKTC CONTACT_KEY_TOKEN_COMP
  iab <buffer> bbDP3F DISTANCE_PLANE_3D_FUNC
  iab <buffer> bbGA GIM_AABB
  iab <buffer> bbGAD GIM_AABB_DATA
  iab <buffer> bbGBBTC GIM_BOX_BOX_TRANSFORM_CACHE
  iab <buffer> bbGBD GIM_BVH_DATA
  iab <buffer> bbGBDA GIM_BVH_DATA_ARRAY
  iab <buffer> bbGBT GIM_BOX_TREE
  iab <buffer> bbGBTN GIM_BOX_TREE_NODE
  iab <buffer> bbGBTN GIM_BVH_TREE_NODE
  iab <buffer> bbGBTNA GIM_BVH_TREE_NODE_ARRAY
  iab <buffer> bbGBTS GIM_BOX_TREE_SET
  iab <buffer> bbGBTTS GIM_BOX_TREE_TEMPLATE_SET
  iab <buffer> bbGC GIM_CONTACT
  iab <buffer> bbGC GIM_CONTACT
  iab <buffer> bbGHNCKM GIM_HASH_NODE_CMP_KEY_MACRO
  iab <buffer> bbGHNCM GIM_HASH_NODE_CMP_MACRO
  iab <buffer> bbGHNGK GIM_HASH_NODE_GET_KEY
  iab <buffer> bbGHTN GIM_HASH_TABLE_NODE
  iab <buffer> bbGP GIM_PAIR
  iab <buffer> bbGPMP GIM_PRIMITIVE_MANAGER_PROTOTYPE
  iab <buffer> bbGQBNA GIM_QUANTIZED_BVH_NODE_ARRAY
  iab <buffer> bbGRT GIM_RSORT_TOKEN
  iab <buffer> bbGRTC GIM_RSORT_TOKEN_COMPARATOR
  iab <buffer> bbGS GIM_ShapeRetriever
  iab <buffer> bbGSA GIM_STANDARD_ALLOCATOR
  iab <buffer> bbGT GIM_TRIANGLE
  iab <buffer> bbGTC GIM_TRIANGLE_CONTACT
  iab <buffer> bbGTCC GIM_TRIANGLE_CALCULATION_CACHE
  iab <buffer> bbGTCD GIM_TRIANGLE_CONTACT_DATA
  iab <buffer> bbGTTC GIM_TREE_TREE_COLLIDER
  iab <buffer> bbLt LinkDeps_t
  iab <buffer> bba b3Aabb
  iab <buffer> bba idArray
  iab <buffer> bba idArray
  iab <buffer> bba idArray
  iab <buffer> bba idArray
  iab <buffer> bbaa b3AlignedAllocator
  iab <buffer> bbaa btAlignedAllocator
  iab <buffer> bbaabb btAABB
  iab <buffer> bbab3 btAlignedBox3d
  iab <buffer> bbaca btActivatingCollisionAlgorithm
  iab <buffer> bbaccl AllocContactConstraintsLoop
  iab <buffer> bbacf b3AngleCompareFunc
  iab <buffer> bbacf btAngleCompareFunc
  iab <buffer> bbactgbl AssignConstraintsToGridBatchesLoop
  iab <buffer> bbactgbp AssignConstraintsToGridBatchesParams
  iab <buffer> bbagrs __anone68ca4840110::GridRaycastState
  iab <buffer> bbai btActionInterface
  iab <buffer> bbal b3AngularLimit
  iab <buffer> bbal btAngularLimit
  iab <buffer> bbaoa b3AlignedObjectArray
  iab <buffer> bbaoa btAlignedObjectArray
  iab <buffer> bbas3 btAxisSweep3
  iab <buffer> bbas3i btAxisSweep3Internal
  iab <buffer> bbb b3Block
  iab <buffer> bbb btBlock
  iab <buffer> bbb2b2ca btBox2dBox2dCollisionAlgorithm
  iab <buffer> bbb2s btBox2dShape
  iab <buffer> bbb3sb2bsid Bullet3SerializeBullet2::b3BvhSubtreeInfoData
  iab <buffer> bbb3sb2chsd Bullet3SerializeBullet2::b3ConvexHullShapeData
  iab <buffer> bbb3sb2ci1 Bullet3SerializeBullet2::b3ConstraintInfo1
  iab <buffer> bbb3sb2cisd Bullet3SerializeBullet2::b3ConvexInternalShapeData
  iab <buffer> bbb3sb2citd Bullet3SerializeBullet2::b3CharIndexTripletData
  iab <buffer> bbb3sb2codd Bullet3SerializeBullet2::b3CollisionObjectDoubleData
  iab <buffer> bbb3sb2cofd Bullet3SerializeBullet2::b3CollisionObjectFloatData
  iab <buffer> bbb3sb2cscd Bullet3SerializeBullet2::b3CompoundShapeChildData
  iab <buffer> bbb3sb2csd Bullet3SerializeBullet2::b3CapsuleShapeData
  iab <buffer> bbb3sb2csd Bullet3SerializeBullet2::b3CollisionShapeData
  iab <buffer> bbb3sb2csd Bullet3SerializeBullet2::b3CompoundShapeData
  iab <buffer> bbb3sb2csd Bullet3SerializeBullet2::b3CylinderShapeData
  iab <buffer> bbb3sb2csidd Bullet3SerializeBullet2::b3ContactSolverInfoDoubleData
  iab <buffer> bbb3sb2csifd Bullet3SerializeBullet2::b3ContactSolverInfoFloatData
  iab <buffer> bbb3sb2ctcd Bullet3SerializeBullet2::b3ConeTwistConstraintData
  iab <buffer> bbb3sb2dwdd Bullet3SerializeBullet2::b3DynamicsWorldDoubleData
  iab <buffer> bbb3sb2dwfd Bullet3SerializeBullet2::b3DynamicsWorldFloatData
  iab <buffer> bbb3sb2g6dcd Bullet3SerializeBullet2::b3Generic6DofConstraintData
  iab <buffer> bbb3sb2g6dscd Bullet3SerializeBullet2::b3Generic6DofSpringConstraintData
  iab <buffer> bbb3sb2gimsd Bullet3SerializeBullet2::b3GImpactMeshShapeData
  iab <buffer> bbb3sb2hcdd Bullet3SerializeBullet2::b3HingeConstraintDoubleData
  iab <buffer> bbb3sb2hcfd Bullet3SerializeBullet2::b3HingeConstraintFloatData
  iab <buffer> bbb3sb2ih Bullet3SerializeBullet2::bInvalidHandle
  iab <buffer> bbb3sb2iid Bullet3SerializeBullet2::b3IntIndexData
  iab <buffer> bbb3sb2lb Bullet3SerializeBullet2::ListBase
  iab <buffer> bbb3sb2m33dd Bullet3SerializeBullet2::b3Matrix3x3DoubleData
  iab <buffer> bbb3sb2m33fd Bullet3SerializeBullet2::b3Matrix3x3FloatData
  iab <buffer> bbb3sb2mpd Bullet3SerializeBullet2::b3MeshPartData
  iab <buffer> bbb3sb2mssd Bullet3SerializeBullet2::b3MultiSphereShapeData
  iab <buffer> bbb3sb2obndd Bullet3SerializeBullet2::b3OptimizedBvhNodeDoubleData
  iab <buffer> bbb3sb2obnfd Bullet3SerializeBullet2::b3OptimizedBvhNodeFloatData
  iab <buffer> bbb3sb2p2pcdd Bullet3SerializeBullet2::b3Point2PointConstraintDoubleData
  iab <buffer> bbb3sb2p2pcfd Bullet3SerializeBullet2::b3Point2PointConstraintFloatData
  iab <buffer> bbb3sb2pa Bullet3SerializeBullet2::PointerArray
  iab <buffer> bbb3sb2par Bullet3SerializeBullet2::b3PositionAndRadius
  iab <buffer> bbb3sb2ps Bullet3SerializeBullet2::b3PhysicsSystem
  iab <buffer> bbb3sb2qbdd Bullet3SerializeBullet2::b3QuantizedBvhDoubleData
  iab <buffer> bbb3sb2qbfd Bullet3SerializeBullet2::b3QuantizedBvhFloatData
  iab <buffer> bbb3sb2qbnd Bullet3SerializeBullet2::b3QuantizedBvhNodeData
  iab <buffer> bbb3sb2rbdd Bullet3SerializeBullet2::b3RigidBodyDoubleData
  iab <buffer> bbb3sb2rbfd Bullet3SerializeBullet2::b3RigidBodyFloatData
  iab <buffer> bbb3sb2sbcd Bullet3SerializeBullet2::SoftBodyClusterData
  iab <buffer> bbb3sb2sbcd Bullet3SerializeBullet2::SoftBodyConfigData
  iab <buffer> bbb3sb2sbfd Bullet3SerializeBullet2::SoftBodyFaceData
  iab <buffer> bbb3sb2sbfd Bullet3SerializeBullet2::b3SoftBodyFloatData
  iab <buffer> bbb3sb2sbjd Bullet3SerializeBullet2::b3SoftBodyJointData
  iab <buffer> bbb3sb2sbld Bullet3SerializeBullet2::SoftBodyLinkData
  iab <buffer> bbb3sb2sbmd Bullet3SerializeBullet2::SoftBodyMaterialData
  iab <buffer> bbb3sb2sbnd Bullet3SerializeBullet2::SoftBodyNodeData
  iab <buffer> bbb3sb2sbpd Bullet3SerializeBullet2::SoftBodyPoseData
  iab <buffer> bbb3sb2sbtd Bullet3SerializeBullet2::SoftBodyTetraData
  iab <buffer> bbb3sb2scd Bullet3SerializeBullet2::b3SliderConstraintData
  iab <buffer> bbb3sb2siid Bullet3SerializeBullet2::b3ShortIntIndexData
  iab <buffer> bbb3sb2siitd Bullet3SerializeBullet2::b3ShortIntIndexTripletData
  iab <buffer> bbb3sb2smid Bullet3SerializeBullet2::b3StridingMeshInterfaceData
  iab <buffer> bbb3sb2spsd Bullet3SerializeBullet2::b3StaticPlaneShapeData
  iab <buffer> bbb3sb2srad Bullet3SerializeBullet2::SoftRigidAnchorData
  iab <buffer> bbb3sb2stmsd Bullet3SerializeBullet2::b3ScaledTriangleMeshShapeData
  iab <buffer> bbb3sb2tcd Bullet3SerializeBullet2::b3TypedConstraintData
  iab <buffer> bbb3sb2tdd Bullet3SerializeBullet2::b3TransformDoubleData
  iab <buffer> bbb3sb2tfd Bullet3SerializeBullet2::b3TransformFloatData
  iab <buffer> bbb3sb2tid Bullet3SerializeBullet2::b3TriangleInfoData
  iab <buffer> bbb3sb2timd Bullet3SerializeBullet2::b3TriangleInfoMapData
  iab <buffer> bbb3sb2tmsd Bullet3SerializeBullet2::b3TriangleMeshShapeData
  iab <buffer> bbb3sb2v3dd Bullet3SerializeBullet2::b3Vector3DoubleData
  iab <buffer> bbb3sb2v3fd Bullet3SerializeBullet2::b3Vector3FloatData
  iab <buffer> bbbL btGEN_Link
  iab <buffer> bbbL btGEN_List
  iab <buffer> bbbS btBU_Simplex1to4
  iab <buffer> bbbac b3BroadphaseAabbCallback
  iab <buffer> bbbac btBroadphaseAabbCallback
  iab <buffer> bbbat BroadphaseAabbTester
  iab <buffer> bbbat BroadphaseAabbTester
  iab <buffer> bbbb b3BroadphaseBenchmark
  iab <buffer> bbbb btBroadphaseBenchmark
  iab <buffer> bbbbca btBoxBoxCollisionAlgorithm
  iab <buffer> bbbbd btBoxBoxDetector
  iab <buffer> bbbc b3BatchConstraint
  iab <buffer> bbbc btBatchedConstraints
  iab <buffer> bbbci btBatchedConstraintInfo
  iab <buffer> bbbi b3BvhInfo
  iab <buffer> bbbi btBatchInfo
  iab <buffer> bbbi btBroadphaseInterface
  iab <buffer> bbbicl b3BufferInfoCL
  iab <buffer> bbbmr btBridgedManifoldResult
  iab <buffer> bbbp btBroadphasePair
  iab <buffer> bbbp btBroadphaseProxy
  iab <buffer> bbbpsp b3BroadphasePairSortPredicate
  iab <buffer> bbbpsp btBroadphasePairSortPredicate
  iab <buffer> bbbrc b3BroadphaseRayCallback
  iab <buffer> bbbrc btBroadphaseRayCallback
  iab <buffer> bbbrt BroadphaseRayTester
  iab <buffer> bbbrt BroadphaseRayTester
  iab <buffer> bbbs btBoxShape
  iab <buffer> bbbsa btBulletSerializedArrays
  iab <buffer> bbbscl b3BoundSearchCL
  iab <buffer> bbbsi btBvhSubtreeInfo
  iab <buffer> bbbsid b3BvhSubtreeInfoData
  iab <buffer> bbbsid btBvhSubtreeInfoData
  iab <buffer> bbbt btBvhTree
  iab <buffer> bbbtms btBvhTriangleMeshShape
  iab <buffer> bbc Collidable
  iab <buffer> bbc Coplanar
  iab <buffer> bbc b3Chunk
  iab <buffer> bbc b3Collidable
  iab <buffer> bbc b3Config
  iab <buffer> bbc btChunk
  iab <buffer> bbc btClock
  iab <buffer> bbc pointCmp
  iab <buffer> bbc2c2a btConvex2dConvex2dAlgorithm
  iab <buffer> bbc2s btConvex2dShape
  iab <buffer> bbc32 btCell32
  iab <buffer> bbc4d b3Contact4Data
  iab <buffer> bbca btCollisionAlgorithm
  iab <buffer> bbca btContactArray
  iab <buffer> bbcacf btCollisionAlgorithmCreateFunc
  iab <buffer> bbcaci btCollisionAlgorithmConstructionInfo
  iab <buffer> bbcbl ConvertBodiesLoop
  iab <buffer> bbcc b3ConstraintCfg
  iab <buffer> bbcc btCollisionConfiguration
  iab <buffer> bbcc btContactConstraint
  iab <buffer> bbcc btConvexCast
  iab <buffer> bbcc4 b3ContactConstraint4
  iab <buffer> bbcca btCompoundCollisionAlgorithm
  iab <buffer> bbcca btConvexConvexAlgorithm
  iab <buffer> bbccc btContinuousConvexCollision
  iab <buffer> bbccca btCompoundCompoundCollisionAlgorithm
  iab <buffer> bbccca btConvexConcaveCollisionAlgorithm
  iab <buffer> bbcci btCharacterControllerInterface
  iab <buffer> bbcclc btCompoundCompoundLeafCallback
  iab <buffer> bbccmcil CollectContactManifoldCachedInfoLoop
  iab <buffer> bbcd btClockData
  iab <buffer> bbcd btCollisionDispatcher
  iab <buffer> bbcdm btCollisionDispatcherMt
  iab <buffer> bbcdu CollisionDispatcherUpdater
  iab <buffer> bbcef copy_elements_func
  iab <buffer> bbcfgs btCompoundFromGimpactShape
  iab <buffer> bbcfsl ContactFrictionSolverLoop
  iab <buffer> bbcfu btCpuFeatureUtility
  iab <buffer> bbcg btConjugateGradient
  iab <buffer> bbcgp btCGProjection
  iab <buffer> bbch ConvexH
  iab <buffer> bbchc b3ConvexHullComputer
  iab <buffer> bbchc btConvexHullComputer
  iab <buffer> bbchi b3ConvexHullInternal
  iab <buffer> bbchi btConvexHullInternal
  iab <buffer> bbchs btConvexHullShape
  iab <buffer> bbchsd btConvexHullShapeData
  iab <buffer> bbciacs btConvexInternalAabbCachingShape
  iab <buffer> bbcis btConvexInternalShape
  iab <buffer> bbcisd btConvexInternalShapeData
  iab <buffer> bbcitd b3CharIndexTripletData
  iab <buffer> bbcitd btCharIndexTripletData
  iab <buffer> bbcjl ConvertJointsLoop
  iab <buffer> bbcla b3CommandLineArgs
  iab <buffer> bbclc btCompoundLeafCallback
  iab <buffer> bbcnmcrc btClosestNotMeConvexResultCallback
  iab <buffer> bbcnp b3CpuNarrowPhase
  iab <buffer> bbcnpid b3CpuNarrowPhaseInternalData
  iab <buffer> bbco btCollisionObject
  iab <buffer> bbcoc CheckOverlapCallback
  iab <buffer> bbcodd btCollisionObjectDoubleData
  iab <buffer> bbcofd btCollisionObjectFloatData
  iab <buffer> bbcop b3CompoundOverlappingPair
  iab <buffer> bbcow btCollisionObjectWrapper
  iab <buffer> bbcp b3ContactPoint
  iab <buffer> bbcp btConnectivityProcessor
  iab <buffer> bbcp btConvexPolyhedron
  iab <buffer> bbcpc btCollisionPairCallback
  iab <buffer> bbcpca btConvexPlaneCollisionAlgorithm
  iab <buffer> bbcpcs btConvexPointCloudShape
  iab <buffer> bbcpd b3ConvexPolyhedronData
  iab <buffer> bbcpds btConvexPenetrationDepthSolver
  iab <buffer> bbcpi CProfileIterator
  iab <buffer> bbcpm CProfileManager
  iab <buffer> bbcpn CProfileNode
  iab <buffer> bbcps CProfileSample
  iab <buffer> bbcpuvbd btCPUVertexBufferDescriptor
  iab <buffer> bbcr btConstraintRow
  iab <buffer> bbcrbp b3CpuRigidBodyPipeline
  iab <buffer> bbcrbpid b3CpuRigidBodyPipelineInternalData
  iab <buffer> bbcrfsl ContactRollingFrictionSolverLoop
  iab <buffer> bbcs b3ConstraintSetting
  iab <buffer> bbcs btCapsuleShape
  iab <buffer> bbcs btCollisionShape
  iab <buffer> bbcs btCompoundShape
  iab <buffer> bbcs btConcaveShape
  iab <buffer> bbcs btConeShape
  iab <buffer> bbcs btConstraintSetting
  iab <buffer> bbcs btConstraintSolver
  iab <buffer> bbcs btConvexShape
  iab <buffer> bbcs btCriticalSection
  iab <buffer> bbcs btCylinderShape
  iab <buffer> bbcsc btCompoundShapeChild
  iab <buffer> bbcscd btCompoundShapeChildData
  iab <buffer> bbcsd btCapsuleShapeData
  iab <buffer> bbcsd btCollisionShapeData
  iab <buffer> bbcsd btCompoundShapeData
  iab <buffer> bbcsd btConeShapeData
  iab <buffer> bbcsd btCylinderShapeData
  iab <buffer> bbcsdu b3ConvexSeparatingDistanceUtil
  iab <buffer> bbcsdu btConvexSeparatingDistanceUtil
  iab <buffer> bbcsi b3ContactSolverInfo
  iab <buffer> bbcsi btContactSolverInfo
  iab <buffer> bbcsid b3ContactSolverInfoData
  iab <buffer> bbcsid btContactSolverInfoData
  iab <buffer> bbcsidd b3ContactSolverInfoDoubleData
  iab <buffer> bbcsidd btContactSolverInfoDoubleData
  iab <buffer> bbcsifd b3ContactSolverInfoFloatData
  iab <buffer> bbcsifd btContactSolverInfoFloatData
  iab <buffer> bbcsl ContactSolverLoop
  iab <buffer> bbcsp btCriticalSectionPosix
  iab <buffer> bbcspisl ContactSplitPenetrationImpulseSolverLoop
  iab <buffer> bbcspm btConstraintSolverPoolMt
  iab <buffer> bbcsx btCapsuleShapeX
  iab <buffer> bbcsx btConeShapeX
  iab <buffer> bbcsx btCylinderShapeX
  iab <buffer> bbcsz btCapsuleShapeZ
  iab <buffer> bbcsz btConeShapeZ
  iab <buffer> bbcsz btCylinderShapeZ
  iab <buffer> bbctc btConeTwistConstraint
  iab <buffer> bbctc btConvexTriangleCallback
  iab <buffer> bbctcd btConeTwistConstraintData
  iab <buffer> bbctcdd btConeTwistConstraintDoubleData
  iab <buffer> bbctms btConvexTriangleMeshShape
  iab <buffer> bbcv ClipVertex
  iab <buffer> bbcw btCollisionWorld
  iab <buffer> bbcwi btCollisionWorldImporter
  iab <buffer> bbd btDbvt
  iab <buffer> bbd btDispatcher
  iab <buffer> bbdam b3DbvtAabbMm
  iab <buffer> bbdam btDbvtAabbMm
  iab <buffer> bbdb b3DbvtBenchmark
  iab <buffer> bbdb b3DynamicBvh
  iab <buffer> bbdb btDbvtBenchmark
  iab <buffer> bbdb btDbvtBroadphase
  iab <buffer> bbdbb b3DynamicBvhBroadphase
  iab <buffer> bbdbeo btDeformableBackwardEulerObjective
  iab <buffer> bbdbs btDeformableBodySolver
  iab <buffer> bbdcc DeformableContactConstraint
  iab <buffer> bbdcc btDefaultCollisionConfiguration
  iab <buffer> bbdcc btDeformableContactConstraint
  iab <buffer> bbdcci btDefaultCollisionConstructionInfo
  iab <buffer> bbdcdi btDiscreteCollisionDetectorInterface
  iab <buffer> bbdcf btDeformableCorotatedForce
  iab <buffer> bbdcp btDeformableContactProjection
  iab <buffer> bbdd DebugDrawcallback
  iab <buffer> bbddw btDiscreteDynamicsWorld
  iab <buffer> bbddwm btDiscreteDynamicsWorldMt
  iab <buffer> bbdf fDrawFlags
  iab <buffer> bbdfncc btDeformableFaceNodeContactConstraint
  iab <buffer> bbdfrcc btDeformableFaceRigidContactConstraint
  iab <buffer> bbdgf btDeformableGravityForce
  iab <buffer> bbdi btDispatcherInfo
  iab <buffer> bbdlef btDeformableLinearElasticityForce
  iab <buffer> bbdlf btDeformableLagrangianForce
  iab <buffer> bbdmbcs btDeformableMultiBodyConstraintSolver
  iab <buffer> bbdmbdw btDeformableMultiBodyDynamicsWorld
  iab <buffer> bbdms btDefaultMotionState
  iab <buffer> bbdmsf btDeformableMassSpringForce
  iab <buffer> bbdn b3DbvtNode
  iab <buffer> bbdn btDbvntNode
  iab <buffer> bbdn btDbvtNode
  iab <buffer> bbdnac btDeformableNodeAnchorConstraint
  iab <buffer> bbdne b3DbvtNodeEnumerator
  iab <buffer> bbdne btDbvtNodeEnumerator
  iab <buffer> bbdnhf btDeformableNeoHookeanForce
  iab <buffer> bbdnrcc btDeformableNodeRigidContactConstraint
  iab <buffer> bbdp DefaultPreconditioner
  iab <buffer> bbdp b3DbvtProxy
  iab <buffer> bbdp btDbvtProxy
  iab <buffer> bbdpm btDebugPtrMagic
  iab <buffer> bbdrcc btDeformableRigidContactConstraint
  iab <buffer> bbds b3DefaultSerializer
  iab <buffer> bbds btDantzigSolver
  iab <buffer> bbds btDefaultSerializer
  iab <buffer> bbdsbs btDefaultSoftBodySolver
  iab <buffer> bbdsc btDeformableStaticConstraint
  iab <buffer> bbdsm btDantzigScratchMemory
  iab <buffer> bbdtc b3DbvtTreeCollider
  iab <buffer> bbdtc btDbvtTreeCollider
  iab <buffer> bbdvr btDefaultVehicleRaycaster
  iab <buffer> bbdw btDynamicsWorld
  iab <buffer> bbdwdd btDynamicsWorldDoubleData
  iab <buffer> bbdwfd btDynamicsWorldFloatData
  iab <buffer> bbe btEigen
  iab <buffer> bbe btElement
  iab <buffer> bbea btEmptyAlgorithm
  iab <buffer> bbecrl ExpandConstraintRowsLoop
  iab <buffer> bbef EdgeFlag
  iab <buffer> bbepa EPA
  iab <buffer> bbes btEmptyShape
  iab <buffer> bbf btFace
  iab <buffer> bbfc btFixedConstraint
  iab <buffer> bbfcl b3FillCL
  iab <buffer> bbfu b3FileUtils
  iab <buffer> bbg6dc btGeneric6DofConstraint
  iab <buffer> bbg6dcd btGeneric6DofConstraintData
  iab <buffer> bbg6dcdd2 btGeneric6DofConstraintDoubleData2
  iab <buffer> bbg6ds2c btGeneric6DofSpring2Constraint
  iab <buffer> bbg6ds2cd btGeneric6DofSpring2ConstraintData
  iab <buffer> bbg6ds2cdd2 btGeneric6DofSpring2ConstraintDoubleData2
  iab <buffer> bbg6dsc btGeneric6DofSpringConstraint
  iab <buffer> bbg6dscd btGeneric6DofSpringConstraintData
  iab <buffer> bbg6dscdd2 btGeneric6DofSpringConstraintDoubleData2
  iab <buffer> bbga gim_array
  iab <buffer> bbgb gim_bitset
  iab <buffer> bbgbi b3GpuBroadphaseInterface
  iab <buffer> bbgbpsid b3GpuBatchingPgsSolverInternalData
  iab <buffer> bbgc btGearConstraint
  iab <buffer> bbgca gim_contact_array
  iab <buffer> bbgcc btGjkConvexCast
  iab <buffer> bbgcd btGjkCollisionDescription
  iab <buffer> bbgcdd btGearConstraintDoubleData
  iab <buffer> bbgcfd btGearConstraintFloatData
  iab <buffer> bbgci2 b3GpuConstraintInfo2
  iab <buffer> bbgcs b3GpuChildShape
  iab <buffer> bbgepds btGjkEpaPenetrationDepthSolver
  iab <buffer> bbges2 b3GjkEpaSolver2
  iab <buffer> bbges2 btGjkEpaSolver2
  iab <buffer> bbges3 btGjkEpaSolver3
  iab <buffer> bbgf b3GpuFace
  iab <buffer> bbggb b3GpuGridBroadphase
  iab <buffer> bbght gim_hash_table
  iab <buffer> bbgib btGImpactBvh
  iab <buffer> bbgica btGImpactCollisionAlgorithm
  iab <buffer> bbgics btGImpactCompoundShape
  iab <buffer> bbgiepa gjkepa2_impl2::b3EPA
  iab <buffer> bbgiepa gjkepa2_impl::EPA
  iab <buffer> bbgigjk gjkepa2_impl2::b3GJK
  iab <buffer> bbgigjk gjkepa2_impl::GJK
  iab <buffer> bbgimd gjkepa2_impl2::b3MinkowskiDiff
  iab <buffer> bbgimd gjkepa2_impl::MinkowskiDiff
  iab <buffer> bbgims btGImpactMeshShape
  iab <buffer> bbgimsd btGImpactMeshShapeData
  iab <buffer> bbgimsp btGImpactMeshShapePart
  iab <buffer> bbgiqb btGImpactQuantizedBvh
  iab <buffer> bbgisi btGImpactShapeInterface
  iab <buffer> bbgitc btGImpactTriangleCallback
  iab <buffer> bbgjcs b3GpuJacobiContactSolver
  iab <buffer> bbgjk GJK
  iab <buffer> bbgjsid b3GpuJacobiSolverInternalData
  iab <buffer> bbgmp btGenericMemoryPool
  iab <buffer> bbgnp b3GpuNarrowPhase
  iab <buffer> bbgnpid b3GpuNarrowPhaseInternalData
  iab <buffer> bbgo btGhostObject
  iab <buffer> bbgpa btGenericPoolAllocator
  iab <buffer> bbgpc btGhostPairCallback
  iab <buffer> bbgpcs b3GpuPgsConstraintSolver
  iab <buffer> bbgpcs b3GpuPgsContactSolver
  iab <buffer> bbgpd btGjkPairDetector
  iab <buffer> bbgpjsid b3GpuPgsJacobiSolverInternalData
  iab <buffer> bbgplb b3GpuParallelLinearBvh
  iab <buffer> bbgplbb b3GpuParallelLinearBvhBroadphase
  iab <buffer> bbgps gim_pair_set
  iab <buffer> bbgr GivensRotation
  iab <buffer> bbgr b3GpuRaycast
  iab <buffer> bbgrbp b3GpuRigidBodyPipeline
  iab <buffer> bbgrbpid b3GpuRigidBodyPipelineInternalData
  iab <buffer> bbgrid b3GpuRaycastInternalData
  iab <buffer> bbgsb b3GpuSapBroadphase
  iab <buffer> bbgsc GpuSatCollision
  iab <buffer> bbgu b3GeometryUtil
  iab <buffer> bbgu btGeometryUtil
  iab <buffer> bbgv3 GrahamVector3
  iab <buffer> bbgv3 b3GrahamVector3
  iab <buffer> bbh2c btHinge2Constraint
  iab <buffer> bbhaac btHingeAccumulatedAngleConstraint
  iab <buffer> bbhc btHingeConstraint
  iab <buffer> bbhcdd btHingeConstraintDoubleData
  iab <buffer> bbhcdd2 btHingeConstraintDoubleData2
  iab <buffer> bbhcfd btHingeConstraintFloatData
  iab <buffer> bbhd HullDesc
  iab <buffer> bbhi b3HashInt
  iab <buffer> bbhi btHashInt
  iab <buffer> bbhk b3HashKey
  iab <buffer> bbhk btHashKey
  iab <buffer> bbhkp b3HashKeyPtr
  iab <buffer> bbhkp btHashKeyPtr
  iab <buffer> bbhl HullLibrary
  iab <buffer> bbhm b3HashMap
  iab <buffer> bbhm btHashMap
  iab <buffer> bbhopc b3HashedOverlappingPairCache
  iab <buffer> bbhopc btHashedOverlappingPairCache
  iab <buffer> bbhp b3HashPtr
  iab <buffer> bbhp btHashPtr
  iab <buffer> bbhr HullResult
  iab <buffer> bbhs b3HashString
  iab <buffer> bbhs btHashString
  iab <buffer> bbhspc btHashedSimplePairCache
  iab <buffer> bbht btHullTriangle
  iab <buffer> bbhts btHeightfieldTerrainShape
  iab <buffer> bbi b3Inertia
  iab <buffer> bbi2 b3Int2
  iab <buffer> bbibcsp IslandBodyCapacitySortPredicate
  iab <buffer> bbibssp IslandBatchSizeSortPredicate
  iab <buffer> bbic integer_comparator
  iab <buffer> bbicsl InterleavedContactSolverLoop
  iab <buffer> bbid b3InertiaData
  iab <buffer> bbid btInverseDynamics::matxx
  iab <buffer> bbid btInverseDynamics::vecx
  iab <buffer> bbid btInverseDynamics::vecx
  iab <buffer> bbid3 btInverseDynamics::mat3x
  iab <buffer> bbid3 btInverseDynamics::mat3x
  iab <buffer> bbid3 btInverseDynamics::vec3
  iab <buffer> bbid3 btInverseDynamics::vec3
  iab <buffer> bbid33 btInverseDynamics::mat33
  iab <buffer> bbid33 btInverseDynamics::mat33
  iab <buffer> bbidd btIDebugDraw
  iab <buffer> bbidid btInverseDynamics::InertiaData
  iab <buffer> bbidjd btInverseDynamics::JointData
  iab <buffer> bbidmbt btInverseDynamics::MultiBodyTree
  iab <buffer> bbidrb btInverseDynamics::RigidBody
  iab <buffer> bbie b3InternalEdge
  iab <buffer> bbie btInternalEdge
  iab <buffer> bbiid b3IntIndexData
  iab <buffer> bbiid btIntIndexData
  iab <buffer> bbijl InitJointsLoop
  iab <buffer> bbim btIndexedMesh
  iab <buffer> bbimc btInfMaskConverter
  iab <buffer> bbims btInMemorySerializer
  iab <buffer> bbipfb btIParallelForBody
  iab <buffer> bbipsb btIParallelSumBody
  iab <buffer> bbisic InplaceSolverIslandCallback
  iab <buffer> bbisp btIntSortPredicate
  iab <buffer> bbitic b3InternalTriangleIndexCallback
  iab <buffer> bbitic btInternalTriangleIndexCallback
  iab <buffer> bbits btITaskScheduler
  iab <buffer> bbiv3 btIntVec3
  iab <buffer> bbivp b3InternalVertexPair
  iab <buffer> bbivp btInternalVertexPair
  iab <buffer> bbje btJacobianEntry
  iab <buffer> bbjf btJointFeedback
  iab <buffer> bbjn btJointNode
  iab <buffer> bbjn1 btJointNode1
  iab <buffer> bbjsi b3JacobiSolverInfo
  iab <buffer> bbjsl JointSolverLoop
  iab <buffer> bbkadu b3KernelArgDataUnaligned
  iab <buffer> bbkcc btKinematicCharacterController
  iab <buffer> bbkcnmcrc btKinematicClosestNotMeConvexResultCallback
  iab <buffer> bbkcnmrrc btKinematicClosestNotMeRayResultCallback
  iab <buffer> bbla btLemkeAlgorithm
  iab <buffer> bblc less_comparator
  iab <buffer> bblcl b3LauncherCL
  iab <buffer> bblcp btLCP
  iab <buffer> bbls btLemkeSolver
  iab <buffer> bblsvc LocalSupportVertexCallback
  iab <buffer> bbm btMaterial
  iab <buffer> bbm22 btMatrix2x2
  iab <buffer> bbm33 btMatrix3x3
  iab <buffer> bbm33dd b3Matrix3x3DoubleData
  iab <buffer> bbm33dd btMatrix3x3DoubleData
  iab <buffer> bbm33fd b3Matrix3x3FloatData
  iab <buffer> bbm33fd btMatrix3x3FloatData
  iab <buffer> bbmb btMultiBody
  iab <buffer> bbmbc btMultiBodyConstraint
  iab <buffer> bbmbcs btMultiBodyConstraintSolver
  iab <buffer> bbmbdd btMultiBodyDoubleData
  iab <buffer> bbmbdw btMultiBodyDynamicsWorld
  iab <buffer> bbmbfc btMultiBodyFixedConstraint
  iab <buffer> bbmbfd btMultiBodyFloatData
  iab <buffer> bbmbgc btMultiBodyGearConstraint
  iab <buffer> bbmbisic MultiBodyInplaceSolverIslandCallback
  iab <buffer> bbmbjd btMultiBodyJacobianData
  iab <buffer> bbmbjf btMultiBodyJointFeedback
  iab <buffer> bbmbjlc btMultiBodyJointLimitConstraint
  iab <buffer> bbmbjm btMultiBodyJointMotor
  iab <buffer> bbmblc btMultiBodyLinkCollider
  iab <buffer> bbmblcdd btMultiBodyLinkColliderDoubleData
  iab <buffer> bbmblcfd btMultiBodyLinkColliderFloatData
  iab <buffer> bbmbldd btMultiBodyLinkDoubleData
  iab <buffer> bbmblfd btMultiBodyLinkFloatData
  iab <buffer> bbmbmlcpcs btMultiBodyMLCPConstraintSolver
  iab <buffer> bbmbp2p btMultiBodyPoint2Point
  iab <buffer> bbmbsc btMultiBodySliderConstraint
  iab <buffer> bbmbsc btMultiBodySolverConstraint
  iab <buffer> bbmbsjm btMultiBodySphericalJointMotor
  iab <buffer> bbmc MyCallback
  iab <buffer> bbmcd btMprCollisionDescription
  iab <buffer> bbmd MinkowskiDiff
  iab <buffer> bbmdi btMprDistanceInfo
  iab <buffer> bbmef memcopy_elements_func
  iab <buffer> bbmf b3MyFace
  iab <buffer> bbmi btMultiIndex
  iab <buffer> bbmitic MyInternalTriangleIndexCallback
  iab <buffer> bbml btMultibodyLink
  iab <buffer> bbmlcps btMLCPSolver
  iab <buffer> bbmlcpsi btMLCPSolverInterface
  iab <buffer> bbmp MassPreconditioner
  iab <buffer> bbmp btManifoldPoint
  iab <buffer> bbmp btMaterialProperties
  iab <buffer> bbmpd b3MeshPartData
  iab <buffer> bbmpd btMeshPartData
  iab <buffer> bbmpds btMinkowskiPenetrationDepthSolver
  iab <buffer> bbmpi MyPairIndex
  iab <buffer> bbmpisp MyPairIndeSortPredicate
  iab <buffer> bbmr btManifoldResult
  iab <buffer> bbms btMotionState
  iab <buffer> bbmsdf btMiniSDF
  iab <buffer> bbmss btMinkowskiSumShape
  iab <buffer> bbmss btMultiSphereShape
  iab <buffer> bbmssd btMultiSphereShapeData
  iab <buffer> bbmt MyTest
  iab <buffer> bbmtc MyTriangleCallback
  iab <buffer> bbmtms btMultimaterialTriangleMeshShape
  iab <buffer> bbmx btMatrixX
  iab <buffer> bbnl NodeLinks
  iab <buffer> bbnncgcs btNNCGConstraintSolver
  iab <buffer> bbnoc b3NodeOverlapCallback
  iab <buffer> bbnoc b3NodeOverlapCallback
  iab <buffer> bbnoc btNodeOverlapCallback
  iab <buffer> bbnpc b3NullPairCache
  iab <buffer> bbnpc btNullPairCache
  iab <buffer> bbob btOptimizedBvh
  iab <buffer> bbobn btOptimizedBvhNode
  iab <buffer> bbobndd btOptimizedBvhNodeDoubleData
  iab <buffer> bbobnfd btOptimizedBvhNodeFloatData
  iab <buffer> bboc b3OverlapCallback
  iab <buffer> bboc btOverlapCallback
  iab <buffer> bbocla b3OpenCLArray
  iab <buffer> bboclpi b3OpenCLPlatformInfo
  iab <buffer> bboclu b3OpenCLUtils
  iab <buffer> bbofc b3OverlapFilterCallback
  iab <buffer> bbofc btOverlapFilterCallback
  iab <buffer> bbopc b3OverlappingPairCache
  iab <buffer> bbopc btOverlappingPairCache
  iab <buffer> bbopc btOverlappingPairCallback
  iab <buffer> bbp Preconditioner
  iab <buffer> bbp btPlane
  iab <buffer> bbp2pc btPoint2PointConstraint
  iab <buffer> bbp2pcdd b3Point2PointConstraintDoubleData
  iab <buffer> bbp2pcdd btPoint2PointConstraintDoubleData
  iab <buffer> bbp2pcdd2 btPoint2PointConstraintDoubleData2
  iab <buffer> bbp2pcfd b3Point2PointConstraintFloatData
  iab <buffer> bbp2pcfd btPoint2PointConstraintFloatData
  iab <buffer> bbpa b3PoolAllocator
  iab <buffer> bbpa btPoolAllocator
  iab <buffer> bbpar btPositionAndRadius
  iab <buffer> bbpath b3ProcessAllTrianglesHeightfield
  iab <buffer> bbpbf bParse::b3BulletFile
  iab <buffer> bbpbh b3PoolBodyHandle
  iab <buffer> bbpc btPointCollector
  iab <buffer> bbpcacs btPolyhedralConvexAabbCachingShape
  iab <buffer> bbpcc btPolyhedralContactClipping
  iab <buffer> bbpcgo btPairCachingGhostObject
  iab <buffer> bbpci bParse::bChunkInd
  iab <buffer> bbpcp4 bParse::bChunkPtr4
  iab <buffer> bbpcp8 bParse::bChunkPtr8
  iab <buffer> bbpcr btPerturbedContactResult
  iab <buffer> bbpcs btPolyhedralConvexShape
  iab <buffer> bbpcu bParse::ChunkUtils
  iab <buffer> bbpd btPolarDecomposition
  iab <buffer> bbpdna bParse::bDNA
  iab <buffer> bbpf PlaneFlag
  iab <buffer> bbpf bParse::bFile
  iab <buffer> bbpgbcl b3ParamsGridBroadphaseCL
  iab <buffer> bbphr PHullResult
  iab <buffer> bbpi btProcessorInfo
  iab <buffer> bbpjs b3PgsJacobiSolver
  iab <buffer> bbpm btPersistentManifold
  iab <buffer> bbpmb btPrimitiveManagerBase
  iab <buffer> bbpmdd btPersistentManifoldDoubleData
  iab <buffer> bbpmfd btPersistentManifoldFloatData
  iab <buffer> bbpmh PreallocatedMemoryHelper
  iab <buffer> bbpmsp btPersistentManifoldSortPredicate
  iab <buffer> bbpmspd btPersistentManifoldSortPredicateDeterministic
  iab <buffer> bbpni bParse::bNameInfo
  iab <buffer> bbps ProfileScope
  iab <buffer> bbps b3ProfileScope
  iab <buffer> bbps btPairSet
  iab <buffer> bbps btPathSolver
  iab <buffer> bbps btPlaneShape
  iab <buffer> bbpscl b3PrefixScanCL
  iab <buffer> bbpsf4cl b3PrefixScanFloat4CL
  iab <buffer> bbpsh bParse::bStructHandle
  iab <buffer> bbpt btPrimitiveTriangle
  iab <buffer> bbpta ProcessTrianglesAction
  iab <buffer> bbpu b3PointerUid
  iab <buffer> bbpu btPointerUid
  iab <buffer> bbpvba ProcessVBoundsAction
  iab <buffer> bbpz b3ProfileZone
  iab <buffer> bbq b3Quaternion
  iab <buffer> bbq btQuaternion
  iab <buffer> bbqb btQuantizedBvh
  iab <buffer> bbqbdd btQuantizedBvhDoubleData
  iab <buffer> bbqbfd btQuantizedBvhFloatData
  iab <buffer> bbqbn btQuantizedBvhNode
  iab <buffer> bbqbnd b3QuantizedBvhNodeData
  iab <buffer> bbqbnd btQuantizedBvhNodeData
  iab <buffer> bbqbt btQuantizedBvhTree
  iab <buffer> bbqdd btQuaternionDoubleData
  iab <buffer> bbqfd btQuaternionFloatData
  iab <buffer> bbqw btQuadWord
  iab <buffer> bbrb btRigidBody
  iab <buffer> bbrbd b3RigidBodyData
  iab <buffer> bbrbdd btRigidBodyDoubleData
  iab <buffer> bbrbfd btRigidBodyFloatData
  iab <buffer> bbrlm b3RotationalLimitMotor
  iab <buffer> bbrlm b3RotationalLimitMotor
  iab <buffer> bbrlm btRotationalLimitMotor
  iab <buffer> bbrlm2 btRotationalLimitMotor2
  iab <buffer> bbroc RemovingOverlapCallback
  iab <buffer> bbrp b3ResizablePool
  iab <buffer> bbrpcp RemovePairContainingProxy
  iab <buffer> bbrs32cl b3RadixSort32CL
  iab <buffer> bbrscl ReadSolverConstraintsLoop
  iab <buffer> bbrv btRaycastVehicle
  iab <buffer> bbs b3Serializer
  iab <buffer> bbs b3Solver
  iab <buffer> bbs btSerializer
  iab <buffer> bbs btSimplex
  iab <buffer> bbs2lc btSolve2LinearConstraint
  iab <buffer> bbsa b3StackAlloc
  iab <buffer> bbsa btStackAlloc
  iab <buffer> bbsad btSolverAnalyticsData
  iab <buffer> bbsb b3SolverBase
  iab <buffer> bbsb btSimpleBroadphase
  iab <buffer> bbsb btSoftBody
  iab <buffer> bbsb btSolverBody
  iab <buffer> bbsbca btSphereBoxCollisionAlgorithm
  iab <buffer> bbsbcca btSoftBodyConcaveCollisionAlgorithm
  iab <buffer> bbsbcd SoftBodyClusterData
  iab <buffer> bbsbcd SoftBodyConfigData
  iab <buffer> bbsbcs btSoftBodyCollisionShape
  iab <buffer> bbsbfd SoftBodyFaceData
  iab <buffer> bbsbfd btSoftBodyFloatData
  iab <buffer> bbsbh btSoftBodyHelpers
  iab <buffer> bbsbjd btSoftBodyJointData
  iab <buffer> bbsbld SoftBodyLinkData
  iab <buffer> bbsbmd SoftBodyMaterialData
  iab <buffer> bbsbnd SoftBodyNodeData
  iab <buffer> bbsbp btSimpleBroadphaseProxy
  iab <buffer> bbsbpd SoftBodyPoseData
  iab <buffer> bbsbrbcc btSoftBodyRigidBodyCollisionConfiguration
  iab <buffer> bbsbs btSoftBodySolver
  iab <buffer> bbsbso btSoftBodySolverOutput
  iab <buffer> bbsbtc btSoftBodyTriangleCallback
  iab <buffer> bbsbtd SoftBodyTetraData
  iab <buffer> bbsbtms btScaledBvhTriangleMeshShape
  iab <buffer> bbsbwi btSoftBodyWorldInfo
  iab <buffer> bbsc btSliderConstraint
  iab <buffer> bbsc btSoftColliders
  iab <buffer> bbsc btSolverConstraint
  iab <buffer> bbscc btSingleContactCallback
  iab <buffer> bbscc btSubsimplexConvexCast
  iab <buffer> bbsccl SetupContactConstraintsLoop
  iab <buffer> bbsccs btSoftClusterCollisionShape
  iab <buffer> bbscd btSliderConstraintData
  iab <buffer> bbscdd btSliderConstraintDoubleData
  iab <buffer> bbscoip btSortConstraintOnIslandPredicate
  iab <buffer> bbscoip2 btSortConstraintOnIslandPredicate2
  iab <buffer> bbscs btSdfCollisionShape
  iab <buffer> bbscsid btSdfCollisionShapeInternalData
  iab <buffer> bbsd b3SortData
  iab <buffer> bbsdi SolverDebugInfo
  iab <buffer> bbsdi SolverDeviceInl
  iab <buffer> bbsds btSdfDataStream
  iab <buffer> bbsdw btSimpleDynamicsWorld
  iab <buffer> bbsfv btSpatialForceVector
  iab <buffer> bbsg btShapeGradients
  iab <buffer> bbsh btShapeHull
  iab <buffer> bbsics btSequentialImpulseConstraintSolver
  iab <buffer> bbsicsm btSequentialImpulseConstraintSolverMt
  iab <buffer> bbsiid b3ShortIntIndexData
  iab <buffer> bbsiid btShortIntIndexData
  iab <buffer> bbsiitd b3ShortIntIndexTripletData
  iab <buffer> bbsiitd btShortIntIndexTripletData
  iab <buffer> bbsim btSimulationIslandManager
  iab <buffer> bbsimm btSimulationIslandManagerMt
  iab <buffer> bbsm btShapeMatrix
  iab <buffer> bbsm btSpinMutex
  iab <buffer> bbsm btSymMatrix
  iab <buffer> bbsmbcoip btSortMultiBodyConstraintOnIslandPredicate
  iab <buffer> bbsmbdw btSoftMultiBodyDynamicsWorld
  iab <buffer> bbsmi btStridingMeshInterface
  iab <buffer> bbsmid b3StridingMeshInterfaceData
  iab <buffer> bbsmid btStridingMeshInterfaceData
  iab <buffer> bbsmv btSpatialMotionVector
  iab <buffer> bbsopc b3SortedOverlappingPairCache
  iab <buffer> bbsopc btSortedOverlappingPairCache
  iab <buffer> bbsp btSimplePair
  iab <buffer> bbspgs btSolveProjectedGaussSeidel
  iab <buffer> bbsps btStaticPlaneShape
  iab <buffer> bbspsd btStaticPlaneShapeData
  iab <buffer> bbsr btStorageResult
  iab <buffer> bbsrad SoftRigidAnchorData
  iab <buffer> bbsrc btSingleRayCallback
  iab <buffer> bbsrca btSoftRigidCollisionAlgorithm
  iab <buffer> bbsrdw btSoftRigidDynamicsWorld
  iab <buffer> bbss b3SimdScalar
  iab <buffer> bbss btSimdScalar
  iab <buffer> bbss btSparseSdf
  iab <buffer> bbss btSphereShape
  iab <buffer> bbssc btSingleSweepCallback
  iab <buffer> bbssca btSoftSoftCollisionAlgorithm
  iab <buffer> bbssca btSphereSphereCollisionAlgorithm
  iab <buffer> bbsscr b3SubSimplexClosestResult
  iab <buffer> bbsscr btSubSimplexClosestResult
  iab <buffer> bbssd btSymmetricSpatialDyad
  iab <buffer> bbssi btSimplexSolverInterface
  iab <buffer> bbssrc btSoftSingleRayCallback
  iab <buffer> bbssrc btSoftSingleRayCallback
  iab <buffer> bbst SolveTask
  iab <buffer> bbst b3SolveTask
  iab <buffer> bbstc btScaledTriangleCallback
  iab <buffer> bbstca btSphereTriangleCollisionAlgorithm
  iab <buffer> bbstd SphereTriangleDetector
  iab <buffer> bbstm btSpatialTransformationMatrix
  iab <buffer> bbstmsd btScaledTriangleMeshShapeData
  iab <buffer> bbsv btSupportVector
  iab <buffer> bbsvc SupportVertexCallback
  iab <buffer> bbt btTransform
  iab <buffer> bbt btTriangle
  iab <buffer> bbtb btTriangleBuffer
  iab <buffer> bbtc ThreadsafeCounter
  iab <buffer> bbtc b3TriangleCallback
  iab <buffer> bbtc btTriangleCallback
  iab <buffer> bbtc btTypedConstraint
  iab <buffer> bbtcc btTriangleConvexcastCallback
  iab <buffer> bbtcd b3TypedConstraintData
  iab <buffer> bbtcd btTypedConstraintData
  iab <buffer> bbtcdd btTypedConstraintDoubleData
  iab <buffer> bbtcfd btTypedConstraintFloatData
  iab <buffer> bbtdd b3TransformDoubleData
  iab <buffer> bbtdd btTransformDoubleData
  iab <buffer> bbtfd b3TransformFloatData
  iab <buffer> bbtfd btTransformFloatData
  iab <buffer> bbti btTriIndex
  iab <buffer> bbti btTriangleInfo
  iab <buffer> bbtid btTriangleInfoData
  iab <buffer> bbtim btTriangleInfoMap
  iab <buffer> bbtimd btTriangleInfoMapData
  iab <buffer> bbtiva btTriangleIndexVertexArray
  iab <buffer> bbtivma btTriangleIndexVertexMaterialArray
  iab <buffer> bbtlm b3TranslationalLimitMotor
  iab <buffer> bbtlm b3TranslationalLimitMotor
  iab <buffer> bbtlm btTranslationalLimitMotor
  iab <buffer> bbtlm2 btTranslationalLimitMotor2
  iab <buffer> bbtm btTriangleMesh
  iab <buffer> bbtms btTriangleMeshShape
  iab <buffer> bbtmsd btTriangleMeshShapeData
  iab <buffer> bbto b3TypedObject
  iab <buffer> bbto btTypedObject
  iab <buffer> bbtrc btTriangleRaycastCallback
  iab <buffer> bbts btTriangleShape
  iab <buffer> bbtse btTetrahedronShapeEx
  iab <buffer> bbtse btTriangleShapeEx
  iab <buffer> bbtsi btThreadSupportInterface
  iab <buffer> bbtsomp btTaskSchedulerOpenMP
  iab <buffer> bbtsp btThreadSupportPosix
  iab <buffer> bbtsppl btTaskSchedulerPPL
  iab <buffer> bbtss btTaskSchedulerSequential
  iab <buffer> bbtstbb btTaskSchedulerTBB
  iab <buffer> bbtsw32 btThreadSupportWin32
  iab <buffer> bbtu b3TransformUtil
  iab <buffer> bbtu btTransformUtil
  iab <buffer> bbub b3UsageBitfield
  iab <buffer> bbub btUsageBitfield
  iab <buffer> bbuc btUniversalConstraint
  iab <buffer> bbucbifml UpdateConstraintBatchIdsForMergesLoop
  iab <buffer> bbuf btUnionFind
  iab <buffer> bbufesp btUnionFindElementSortPredicate
  iab <buffer> bbui2 b3UnsignedInt2
  iab <buffer> bbuid UpdateIslandDispatcher
  iab <buffer> bbukf uint_key_func
  iab <buffer> bbuss btUniformScalingShape
  iab <buffer> bbuum UpdaterUnconstrainedMotion
  iab <buffer> bbv3 btVector3
  iab <buffer> bbv3dd b3Vector3DoubleData
  iab <buffer> bbv3dd btVector3DoubleData
  iab <buffer> bbv3fd b3Vector3FloatData
  iab <buffer> bbv3fd btVector3FloatData
  iab <buffer> bbv4 b3Vector4
  iab <buffer> bbv4 btVector4
  iab <buffer> bbvbd btVertexBufferDescriptor
  iab <buffer> bbvf VertFlag
  iab <buffer> bbvr btVehicleRaycaster
  iab <buffer> bbvss btVoronoiSimplexSolver
  iab <buffer> bbvx btVectorX
  iab <buffer> bbw32cs btWin32CriticalSection
  iab <buffer> bbwbl WriteBodiesLoop
  iab <buffer> bbwcp btWheelContactPoint
  iab <buffer> bbwcpl WriteContactPointsLoop
  iab <buffer> bbwi btWheelInfo
  iab <buffer> bbwici btWheelInfoConstructionInfo
  iab <buffer> bbwjl WriteJointsLoop
  iab <buffer> bbwocil WriteOutConstraintIndicesLoop
  iab <buffer> bbwts WorkerThreadStatus
  iab <buffer> bbwts WorkerThreadStatus
endfunction
